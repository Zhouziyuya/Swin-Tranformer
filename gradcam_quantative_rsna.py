...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='RSNA', help='Chestxray14, RSNA, SIIM, CovidQuEx')
    parser.add_argument('--model_type', type=str, default='swin', help='swin, swinv2')
    parser.add_argument('--pretrain_mode', type=str, default='CheXWorld', help='ACEv2_swinv2_large, ACEv2_swinv2, RAD-DINO, adam-v2, eva-x, ark_plus, CheXWorld, Lamps_large_swinv1, FoundationX')
    ...
    parser.add_argument('--pretrain_weight', type=str, default='/sda/zhouziyu/ssl/downstream_checkpoints/RSNA/CheXWorldvit_base_patchsize16_linearprob_224_5/best.pth')
    ...
    parser.add_argument('--bbox_file', default='/sda/zhouziyu/ssl/datasets/ChestXray/RSNA/stage_2_train_labels.csv', type=str, metavar='PATH')
    parser.add_argument('--test_path', default='/sda/zhouziyu/ssl/datasets/ChestXray/RSNA/stage_2_train_images_png/', type=str, metavar='PATH')
    ...
    parser.add_argument('--out_path', default='/nvme1n1/zhouziyu/Swin-Transformer/figures/gradcam/CheXWorld/RSNA/run5', type=str, metavar='PATH')
...
def main():
    ...
    if args.dataset == 'ChestXray14':
        ...
        # Ensure Image Index is string and keep only images present in test_labels
        df['Image Index'] = df['Image Index'].astype(str)
        df = df[df['Image Index'].isin(test_labels.keys())]
    ...
    for cls_idx, cls_name in enumerate(disease_map):
        ...
        if cls_name == 'Lung Opacity' and args.dataset == 'RSNA':
