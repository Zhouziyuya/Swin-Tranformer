...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='SIIM', help='Chestxray14, RSNA, SIIM, CovidQuEx')
    ...
    parser.add_argument('--pretrain_weight', type=str, default='/sda/zhouziyu/ssl/downstream_checkpoints/SIIM/FoundationXswin_base_linearprob_224_5/best.pth')
    ...
    parser.add_argument('--bbox_file', default='/sda/zhouziyu/ssl/datasets/SIIM/png_masks/', type=str, metavar='PATH')
    parser.add_argument('--test_path', default='/sda/zhouziyu/ssl/datasets/SIIM/png_images/', type=str, metavar='PATH')
    ...
    parser.add_argument('--out_path', default='/nvme1n1/zhouziyu/Swin-Transformer/figures/gradcam/FoundationX/SIIM/run5', type=str, metavar='PATH')
    ...
    for cls_idx, cls_name in enumerate(disease_map):
        ...
        for img_idx in image_indices:
            ...
            if label > 0:
                ...
                draw_mask_contour(os.path.join(save_path_red_heatmap_with_gtbox, cls_name, img_name), mask[:,:,0], args.img_size, original_size=True) # draw gt mask contour
