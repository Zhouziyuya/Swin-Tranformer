...
_C.OUTPUT = '/sda/zhouziyu/ssl/downstream_checkpoints/RSNA/'
...
_C.DATA.DATA_PATH = '/sda/zhouziyu/ssl/datasets/ChestXray/RSNA/stage_2_train_images_png/'
# dataset name
_C.DATA.DATASET = 'RSNA'
# dataset lists and labels
_C.DATA.TRAIN_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/RSNA/RSNAPneumonia_train.txt'
_C.DATA.VAL_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/RSNA/RSNAPneumonia_val.txt'
_C.DATA.TEST_LIST = '/nvme1n1/zhouziyu/Swin-Transformer/data/data_split/RSNA/RSNAPneumonia_test.txt'
